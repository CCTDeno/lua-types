...
declare namespace io {
  ...
  function lines<T extends FileReadFormat[]>(
    ...
    LuaMultiReturn<
      [] extends T ? [string] : { [P in keyof T]: FileReadFormatToType<T[P]> }
    >
  >;
  ...
  function read<T extends io.FileReadFormat>(
    format: T,
  ): io.FileReadFormatToType<T> | undefined;
  function read<T extends io.FileReadFormat[]>(
    ...formats: T
  ...
  type FileReadFormatToType<T> = T extends FileReadNumberFormat ? number
    : string;
}
...
interface LuaFile {
  ...
  lines<T extends io.FileReadFormat[]>(
    ...
    LuaMultiReturn<
      [] extends T ? [string]
        : { [P in keyof T]: io.FileReadFormatToType<T[P]> }
    >
  >;
